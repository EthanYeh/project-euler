#Find the maximum total from top to bottom moving to adjacent numbers on the row below of the triangle in "67.txt"

"""This problem is exactly the same as 18 and the code is exactly the same"""

import time
start = time.time()

# get data into a list of rows
with open('67.txt') as infile:
    data = []
    for line in infile:
